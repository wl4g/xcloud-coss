 ...
 * example, when COSS tries to authenticate a request, if Access ID does not
 ...
 * exception in COSS client side. Generally ClientException occurs either before
...
public class ServiceException extends RuntimeException {
	 ...
	 *            A {@link Throwable} instance indicates a specific exception.
	 */
	public ServiceException(String errorMessage, String errorCode, String requestId, String hostId, String rawResponseError,
			Throwable cause) {
	...
	public String getMessage() {
		return getErrorMessage() + "\n[ErrorCode]: " + getErrorCode() + "\n[RequestId]: " + getRequestId() + "\n[HostId]: "
				+ getHostId() + formatRawResponseError();
	}
}