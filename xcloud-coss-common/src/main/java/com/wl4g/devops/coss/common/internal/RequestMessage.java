...
public class RequestMessage extends HttpMesssage {
	...
	private final CossRequest originalRequest;

	public RequestMessage(String bucketName, String key) {
		this(null, bucketName, key);
	}

	public RequestMessage(CossRequest originalRequest, String bucketName, String key) {
		this.originalRequest = (originalRequest == null) ? CossRequest.NOOP : originalRequest;
	}
	...
	public CossRequest getOriginalRequest() {
