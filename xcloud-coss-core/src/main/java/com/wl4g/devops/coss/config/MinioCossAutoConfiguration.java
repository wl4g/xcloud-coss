...
import com.wl4g.devops.coss.minio.MinioEndpoint;
...
/**
 * Default coss implements auto configuration.
 * 
...
public class MinioCossAutoConfiguration {
	...
	final public static String KEY_PROPERTY_PREFIX_MINIO = "spring.cloud.devops.coss.minio";
